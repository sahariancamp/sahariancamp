...
const experiences = [
  {
    ...
    description: 'Journey across the golden dunes on the ships of the desert. Our guided camel treks range from gentle sunset rides to multi-day expeditions deep into the Erg Chebbi.',
  ...
  },
  {
    ...
    description: 'Feel the rush as you carve through the dunes on a powerful quad bike. Expert guides lead you through the most spectacular terrain the Sahara has to offer.',
  ...
  {
    id: 'music',
    title: 'Berber Music Nights',
    subtitle: 'Rhythm of the desert',
    description: 'Under a canopy of stars, the camp comes alive with traditional Berber music. Drums, singing, and dancing around the fire create memories that echo long after you leave.',
  ...
  },
  {
    id: 'yoga',
    title: 'Sunrise Yoga',
    subtitle: 'Salute the Sahara sun',
    description: 'Begin each morning with yoga on the dunes as the first light paints the sand gold. Our certified instructor guides sessions for all levels in this truly transcendent setting.',
  ...
  {
    id: 'gastronomy',
    title: 'Bio Gastronomy',
    subtitle: 'Taste the terroir',
    description: 'A culinary journey through Moroccan flavors, crafted from organic ingredients grown in our desert garden. From traditional tagines to innovative Berber-fusion cuisine.',
