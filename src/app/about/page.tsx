    ...
    <div className="min-h-screen bg-background pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-24">
          <h1 
            className="text-5xl md:text-7xl font-light text-foreground mb-6 tracking-wide"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
          <div className="order-2 lg:order-1 space-y-8">
            <div>
              <h2 className="text-primary text-sm tracking-[0.3em] uppercase mb-3">The Vision</h2>
              <h3 className="text-3xl md:text-4xl text-foreground font-light mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
                A Mirage Made Real
              </h3>
              <p className="text-muted-foreground/70 leading-relaxed text-lg" style={{ fontFamily: "'Amiri', serif" }}>
            ...
            <div className="grid grid-cols-2 gap-6 pt-6 border-t border-primary/20">
              <div>
                ...
                <h4 className="text-foreground font-semibold mb-2">Sustainable Luxury</h4>
                <p className="text-muted-foreground/60 text-sm">Eco-conscious practices honoring the fragile desert ecosystem.</p>
              </div>
              <div>
                <Compass className="w-8 h-8 text-primary mb-4" />
                <h4 className="text-foreground font-semibold mb-2">Authentic Experiences</h4>
                <p className="text-muted-foreground/60 text-sm">Curated journeys guided by local Berber experts.</p>
              </div>
            </div>
          </div>
          
          <div className="order-1 lg:order-2 relative h-[600px] rounded-3xl overflow-hidden border border-primary/20">
        ...
        {/* The Experience */}
        <div className="bg-card rounded-3xl p-8 md:p-16 border border-primary/10 relative overflow-hidden">
          <div className="absolute top-0 right-0 p-8 opacity-10">
            <Star className="w-32 h-32 text-primary" />
          </div>
          
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-5xl text-foreground font-light mb-8" style={{ fontFamily: "'Playfair Display', serif" }}>
              Beyond Accommodation, <br/> <span className="text-primary italic">An Awakening</span>
            </h2>
            <p className="text-muted-foreground/80 text-lg leading-relaxed mb-10" style={{ fontFamily: "'Amiri', serif" }}>
            ...
            <a 
              href="/tents" 
              className="inline-flex items-center gap-3 border border-primary text-primary px-8 py-4 rounded-full hover:bg-primary hover:text-background transition-all duration-300"
            >
